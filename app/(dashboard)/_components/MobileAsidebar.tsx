...
const MobileAsidebar = () => {
  ...
  return (
    <Sheet>
      <SheetTrigger className="relative" title="Mobile Asidebar">
        <AlignJustify size={30} className="cursor-pointer block lg:hidden"/>
      </SheetTrigger>
      <SheetContent side={"left"}>
        <aside className="w-[300px] lg:w-[250px] xl:w-[300px] overflow-y-auto h-full bg-white z-50 transition-transform duration-300 lg:translate-x-[0]">
